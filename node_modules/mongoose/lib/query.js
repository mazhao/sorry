...
/**
 * Binds this query to a models.
 *
 * @param {Model} model the models to which the query is bound
 ...
 * @param {Model} [models] The name of the models you wish to use for population. If not specified, the name is looked up from the Schema ref.
